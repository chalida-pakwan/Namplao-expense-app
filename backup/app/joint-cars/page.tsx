  ...
  return (
    <div className="p-4 pb-20 bg-pastel-cream min-h-screen font-prompt">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Secure Cars Navigation Section */}
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border border-orange-100">
          ...
          <p className="text-gray-600 text-sm mb-4">เข้าร่วมรถด้วยรหัสเฉพาะ หรือดูรถที่คุณเป็นสมาชิก</p>
          <div className="flex gap-3 flex-wrap">
            <button 
              className="transition-all transform hover:scale-105 bg-blue-100 text-gray-800 px-4 py-2 rounded-xl border border-blue-300 shadow hover:bg-blue-200 active:scale-95 flex items-center gap-2"
              onClick={() => router.push('/secure-cars')}
            >
              <span>🚗</span>
              รถที่เข้าร่วม
            </button>
            <button 
              className="transition-all transform hover:scale-105 bg-green-100 text-gray-800 px-4 py-2 rounded-xl border border-green-300 shadow hover:bg-green-200 active:scale-95 flex items-center gap-2"
              onClick={() => router.push('/secure-cars/join')}
            >
              <span>🔓</span>
              เข้าร่วมรถด้วยรหัส
            </button>
